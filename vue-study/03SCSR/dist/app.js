...
// 电影列表
var List = __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 14));
// 电影详情
var Detail = __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 15));
...
function createStore() {
    return new _vuex2.default.Store({
        ...
        mutations: {
            // mutation 必须是同步函数
            getMoviesList: function getMoviesList(state, list) {
                // why not {moviesList}
                state.moviesList = list;
            },
            getMovieDetail: function getMovieDetail(state, detail) {
        ...
        actions: {
            ...
            // action 可以包含异步操作
            getMoviesList: function getMoviesList(context) {
                $.get('https://www.easy-mock.com/mock/595508da9adc231f356dd755/movies-recommand/movies/list', function (data) {
                    context.commit('getMoviesList', data.entity);
                });
            },
            getMovieDetail: function getMovieDetail(context, id) {
                $.get('https://www.easy-mock.com/mock/595508da9adc231f356dd755/movies-recommand/movies/detail/' + id, function (data) {
...
Component.options.__file = "/Users/sql/Desktop/my/github/myTemplates/vue-study/03SCSR/src/components/Index.vue"
...
if (true) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20d53963", Component.options)
  } else {
    hotAPI.reload("data-v-20d53963", Component.options)
  }
...
if (true) {
  module.hot.accept()
  if (module.hot.data) {
     __webpack_require__(1).rerender("data-v-20d53963", module.exports)
  }
}
